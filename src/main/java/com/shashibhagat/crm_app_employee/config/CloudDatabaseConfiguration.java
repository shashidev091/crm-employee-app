...
@Configuration
@EnableMongoRepositories("com.shashibhagat.crm_app_employee.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.shashibhagat.crm_app_employee.config.dbmigrations");
